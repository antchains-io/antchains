...
namespace eosio { namespace chain {
   ...
   void apply_evscreator_updatecheck(apply_context&);
   void apply_evscreator_updatevalue(apply_context&);
   void apply_evsio_transfer(apply_context&);
   void apply_evsio_issue(apply_context&);

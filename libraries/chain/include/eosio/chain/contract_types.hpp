...
FC_REFLECT( eosio::chain::updatecheck                      , (account)(from_check)(to_check) )
FC_REFLECT( eosio::chain::updatevalue                      , (account)(to_value) )

...
abi_def eosio_contract_abi(const abi_def& eosio_system_abi)
{
   ...
   //add by jerry, update account real name bind check state
   eos_abi.structs.emplace_back( struct_def {
      "updatecheck", "", {
         {"account", "account_name"},
         {"from_check", "uint8"},
   ...
   eos_abi.actions.push_back( action_def{name("updatecheck"), "updatecheck",""} );
   eos_abi.actions.push_back( action_def{name("updatevalue"), "updatevalue",""} );
   eos_abi.actions.push_back( action_def{name("transfer"), "transfer",""} );
   eos_abi.actions.push_back( action_def{name("issue"), "issue",""} );
